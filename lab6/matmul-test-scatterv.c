...
void main(int argc, char *argv[])
{
	...
	int coords[2] = {0, 0} MPI_Cart_coords(commCart, rank, ndims, coords);

	MPI_Datatype block, blocktype;
	int displacments = {0, 1, 2, 9, 10, 11, 18, 19, 20);
	int sendCount = {1, 1, 1, 1, 1, 1, 1, 1, 1};
	int recvCount = {9, 9, 9, 9, 9, 9, 9, 9, 9};
